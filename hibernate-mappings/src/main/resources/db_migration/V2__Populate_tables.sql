...
insert into ADDRESS (country, town, street_and_building) values ('Belarus', 'Minsk', 'Rafieva st., 78-344');
...
insert into PUBLISHER (name, address_id) values ('Ecsmo', 3);

insert into BOOK (title, publisher_id) values ('Kolobok', 2);
insert into BOOK (title, publisher_id) values ('Repka', 3);
insert into BOOK (title, publisher_id) values ('Tri porosenka', 3);
